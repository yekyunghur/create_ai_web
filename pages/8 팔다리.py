...
if api_key:
    ...
    # 학생이 좋아하는 물건에 팔다리를 추가하도록 프롬프트 수정
    prompt_with_limbs = f"{prompt} with arms and legs"
    ...
    if st.button("이미지 생성"):
        ...
        # 이미지 출력
        st.image(image_url, caption=f"Generated Image: {prompt_with_limbs}")
else:
